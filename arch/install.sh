...
sudo pacman -S hyprland xdg-desktop-portal-hyprland hyprlock hyprpaper hypridle hyprpicker hyprshutdown --noconfirm
...
sudo pacman -S --needed rust gtk4 base-devel --noconfirm
paru -S ripdrag-git --noconfirm
