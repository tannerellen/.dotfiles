...
# Fonts
paru -S terminus-font ttf-ubuntu-font-family ttf-firacode-nerd ttf-ubuntu-mono-nerd ttf-jetbrains-mono-nerd ttf-adwaita-mono-nerd noto-fonts-emoji noto-fonts-cjk noto-fonts-extra noto-fonts ttf-roboto-flex ttf-liberation ttf-opensans ttf-ms-win11-auto --noconfirm
...
sudo pacman python-uv --noconfirm
